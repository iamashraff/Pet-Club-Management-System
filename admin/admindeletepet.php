...
<head>
                    ...
                    <title>Delete Pet - Admin Dashboard</title>
...
include ('../includes/footer.html');
                    ...
                    if ($num == 1) {
                      ...
                      echo'
                      <label style="font-size:18px; font-weight:bold;" class="text-danger mb-3"><i class="fas fa-trash-alt"></i>&nbsp;Delete A Pet</label>
                      <div class="alert alert-danger border-danger" role="alert">
                      <i class="fa fa-question-circle"></i>&nbsp;&nbsp;Are sure to delete pet <b><i>'; echo $row['pet_name']; echo'</i></b> ?';
                    ...
                    echo'<div class="row g-2">
                      <div class="col-md">
                      <div class="form-floating">
                      <select class="form-select" id="floatingassignuser" aria-label="Assign User" name="memberid" disabled>
                      <option selected>';
                 ...
                 <div class="col-md">
                   ...
                   <label class="form-check-label text-danger" for="yesChange">Yes, I want to delete pet <b><i>'.$row['pet_name'].'</i></b> from the system.</label>
                   </div>
                 </div>
                 </div>
                 ';

                    echo '<button class="btn btn-danger btn-lg btn-block" type="submit" id="saveBtn" name="saveBtn" style="font-size:16px;" disabled ><i class="fas fa-trash-alt"></i>&nbsp; Delete pet</button>';
                    echo '</form>';
                    ...
                    echo 
                    '<script>
                    setTimeout("location.href ='; echo "'viewpet.php?deletepet=success';"; echo'",2000);
                    </script>';
                    }//END FUNCTION
