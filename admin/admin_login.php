...
<head>
      ...
      <div id="intro" class="bg-image vh-120 shadow-1-strong">
        <video style="min-width: 100%; min-height: 100%;" playsinline autoplay muted loop>
          <source class="h-100" src="https://uniklwow.cov-19awareness.com/cat_5.mp4" type="video/mp4" />
        </video>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                      ...
                      $errors = array();
                            ...
                            if (empty($_POST['username'])) {
                              $errors[] = 'You forgot to enter your admin username.';
                            } else {
                            ...
                            if (empty($errors)) {
                              $q = "SELECT admin_id FROM admin WHERE username='$username' AND password=sha1('$password');";
                              $r = @mysqli_query ($dbc, $q);
                                ...
                                if (mysqli_num_rows($r) == 1) {
                                    ...
                                    echo 
                                    '<script>
                                    setTimeout("location.href ='; echo "'viewuser.php';"; echo'",3000);
                                    </script>';
...
<?php include ('../includes/footer.html'); 
        ...
        function loginForm(){
                    ...
                    echo';">
                                ...
                                <h3 class="mb-4"><i class="fas fa-users"></i>&nbsp;<b>Administrator Login</b></h3>
                                ...
                                <div class="row mb-3">
                                                    ...
                                                    <div class="col">
                                                      <div class="form-floating">
                                                        <input type="text" class="form-control rounded-5" id="floatUsername" placeholder="Admin Username" name="username">
                                ...
                                <div class="row mb-2">
                                                    ...
                                                    <button class="btn btn-primary btn-lg btn-block gradient-custom-3" type="submit" style="font-size:16px;">Login&nbsp;&nbsp;&nbsp;<i class="fas fa-sign-in-alt"></i></button>
                                                    </div>
                                </div>
                    ...
                    echo '<!-- Modal -->
                                          ...
                                          <div class="modal-content rounded-6 shadow-lg">
                                            <div class="modal-header bg-dark mb-5 border-bottom-0">
                                              <h6 class="modal-title" style="color:white;" ><i class="fas fa-users" style=""></i>&nbsp;&nbsp;Session Timeout</h6>
                                              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body py-0">
                                              

                                              <p>You are accessing <b>ADMIN LOGIN PAGE </b>!<br>
                                              So, we logged you out from the <b>USER ACCOUNT</b> session.</p>
                                            </div>
                                            <div class="modal-footer flex-column border-top-0">
                                              <button type="button" class="btn btn-lg btn-danger w-100 mx-0" data-bs-dismiss="modal">Close</button>
                                            </div>
        ...
        if(isset($_GET['logout']))
      {
        ...
        <div class="modal-content rounded-6 shadow-lg">
          ...
          <div class="modal-body py-0">
          <p class="text-center text-success">Admin session has been terminated !</p>
